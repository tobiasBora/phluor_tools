(* Here is a demo which shows how config and JS can be used easily To
   edit the configuration, just edit
   config/Test/Hello_conf_services/main.dico. To add a new global
   service (available for all bricks) please go in the subfolder
   services/. For more documentation please go on
   ROOT_PROJECT/doc/.  *)
