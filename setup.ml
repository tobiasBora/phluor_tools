...
(* OASIS_START *)
(* DO NOT EDIT (digest: a7790335856cb38b655845a85eb67a62) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["L\195\169o Colisson"];
          homepage = None;
          synopsis =
            "Phluor_tools wants to provide tools to speed up the creation of\na website based on Eliom.";
          description = None;
          categories = [];
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("$install_data", ["$datadir"; "$pkg_name"; "data"])))
                 ]
            };
          uninstall_custom =
            {
          ...
          files_ab = ["src/phluor_tools/phluor_default.ml.ab"];
          sections =
            [
               Library
                 ({
                     cs_name = "phluor_tools_lib";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "install_data.ml"})
            ];
          plugins =
            [
               (`Extra, "META", Some "0.4");
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "t\t\192\207/\188\018\2277|\240\007\136D\132-";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
