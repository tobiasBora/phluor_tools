...
(* OASIS_START *)
(* DO NOT EDIT (digest: edd39a89f2ecbe1029d023e0a7db4451) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          files_ab = ["src/phluor_tools_lib/settings.ml.ab"];
          sections =
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("unix", None);
                           FindlibPackage ("cmdliner", None);
                           InternalLibrary "phluor_tools_lib";
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("lwt.unix", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\158M\196=\004\204\140T\251\229\191P\196\150s\130";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
